...
// --- Utility: Code block with Monaco Editor ---
  ...
  const sections = data
    ? [
        ...
        },
        {
          ...
          content: (
            <Section title="How to Identify This Problem" icon={Lightbulb}>
        ...
        },
        {
          title: "Base Code",
          content: (
            <Section title="Base Code" icon={Cpu}>
        ...
        },
        {
          title: "Tricks & Tips",
          content: (
            <Section title="Tricks & Tips" icon={Lightbulb}>
        ...
        },
        {
          title: "Algorithm",
          content: (
            <Section title="General Algorithm" icon={Cpu}>
        ...
        },
        {
          ...
          content: (
            <Section title="Time Complexity" icon={Clock}>
              <TextWithLineBreaks text={data.timeabout} />
              <p>
        ...
        },
        {
          ...
          content: (
            <Section title="Space Complexity" icon={Clock}>
              <TextWithLineBreaks text={data.spaceabout || data.spacebout} />
              <p>
                <strong>Answer:</strong>{" "}
                <code className="text-indigo-600">
                  {data.Spaceans || "—"}
        ...
        },
        {
          title: "When & Where",
          content: (
            <Section title="When & Where to Use" icon={BookOpen}>
        ...
        },
        {
          ...
          content: (
            <Section title="Tips & Important Points" icon={Lightbulb}>
        ...
        data.Variants && {
          title: "Variants",
          content: (
            <Section title="Variants" icon={BookOpen}>
              <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 mt-4">
                {Object.keys(data.Variants).map((item, key) => (
                  <motion.button
                    key={key}
        ...
        {data && (
          ...
          >
            ...
            <div className="flex justify-center">
              <button
                onClick={() => router.back()}
                className="mt-8 px-6 py-3 bg-gray-800 text-white rounded-lg shadow-md hover:bg-gray-700 transition"
              >
                ⬅ Back
              </button>
            </div>
